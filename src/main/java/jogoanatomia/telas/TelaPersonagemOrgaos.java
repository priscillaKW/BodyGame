...
<<<<<<< HEAD
	...
	public List<Organ> orgaos = new ArrayList<Organ>();
	...
	public TelaPersonagemOrgaos() {
		...
		List<Organ> organs = organServiceImpl.all();
		if (organs != null) {
			orgaos = organs;
	...
	private void carregaPersonagem() {
		...
		if (this.usuario.getCharacter().getKind().equals("female")) {
			...
			default:
				jLabelPersonagens
						.setIcon(new ImageIcon(TelaSelecionaPersonagens.class
		...
		layout.setVerticalGroup(layout
				...
				.addGroup(
						layout.createSequentialGroup()
								...
								.addGap(18, 18, 18).addComponent(jButtonStart)
								.addContainerGap()));
	...
	private void jButtonStartActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonStartActionPerformed
		...
		if (index != -1 && index <= (usuario.currentStage() + 1)) {
			...
			JOptionPane.showMessageDialog(rootPane,
					"Selecione um órgão para iniciar o jogo");
		}
...
=======
    ...
    public static void main(String args[]) {
        ...
        // <editor-fold defaultstate="collapsed"
        // desc=" Look and feel setting code (optional) ">
>>>>>>> 16a2fbded15764ecbe2ce4ec8a33738e401f0133
		/*
